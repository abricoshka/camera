...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.C0005Op c0005Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) throws Resources.NotFoundException {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        switch (z ? INVERSE_OPS[c0005Op.cmd] : c0005Op.cmd) {
            case 1:
            case FrameMetricsAggregator.DELAY_INDEX /* 7 */:
                if (z2) {
                    z9 = fragment.mIsNewlyAdded;
                } else {
                    z9 = !fragment.mAdded ? !fragment.mHidden : false;
                }
                z4 = true;
                z5 = false;
                z6 = false;
            ...
            case 6:
                if (z2) {
                    ...
                    z3 = fragment.mAdded ? !fragment.mHidden : false;
                }
                z4 = false;
                z5 = z3;
                z6 = true;
            ...
            case 4:
                if (z2) {
                    z8 = (fragment.mHiddenChanged && fragment.mAdded) ? fragment.mHidden : false;
                } else {
                    z8 = fragment.mAdded ? !fragment.mHidden : false;
                }
                z4 = false;
                z5 = z8;
                z6 = true;
            ...
            case 5:
                if (z2) {
                    z10 = (fragment.mHiddenChanged && (fragment.mHidden ^ true)) ? fragment.mAdded : false;
                } else {
