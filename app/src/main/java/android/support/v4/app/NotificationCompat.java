...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) throws Resources.NotFoundException {
            ...
            boolean z8 = ((Build.VERSION.SDK_INT >= 21) || this.mBuilder.mLargeIcon == null) ? false : true;
    ...
    public static class MessagingStyle extends Style {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            boolean zHasMessagesWithoutSender;
            CharSequence text;
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                if (this.mConversationTitle != null) {
                    zHasMessagesWithoutSender = true;
                } else {
                    zHasMessagesWithoutSender = hasMessagesWithoutSender();
                }
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    Message message3 = this.mMessages.get(size);
                    CharSequence charSequenceMakeMessageLine = zHasMessagesWithoutSender ? makeMessageLine(message3) : message3.getText();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, null, allowGeneratedReplies);
    }
