...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            Iterator<T> it = builder.mActions.iterator();
            while (it.hasNext()) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            Iterator<T> it2 = builder.mPeople.iterator();
            while (it2.hasNext()) {
    ...
    protected Notification buildInternal() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            if (this.mGroupAlertBehavior != 0) {
                if (notificationBuild.getGroup() != null && (notificationBuild.flags & NotificationCompat.FLAG_GROUP_SUMMARY) != 0 && this.mGroupAlertBehavior == 2) {
                    removeSoundAndVibration(notificationBuild);
                }
                if (notificationBuild.getGroup() != null && (notificationBuild.flags & NotificationCompat.FLAG_GROUP_SUMMARY) == 0 && this.mGroupAlertBehavior == 1) {
                    removeSoundAndVibration(notificationBuild);
                }
            }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (this.mGroupAlertBehavior != 0) {
                if (notificationBuild2.getGroup() != null && (notificationBuild2.flags & NotificationCompat.FLAG_GROUP_SUMMARY) != 0 && this.mGroupAlertBehavior == 2) {
                    removeSoundAndVibration(notificationBuild2);
                }
                if (notificationBuild2.getGroup() != null && (notificationBuild2.flags & NotificationCompat.FLAG_GROUP_SUMMARY) == 0 && this.mGroupAlertBehavior == 1) {
                    removeSoundAndVibration(notificationBuild2);
                }
            }
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            if (this.mGroupAlertBehavior != 0) {
                if (notificationBuild3.getGroup() != null && (notificationBuild3.flags & NotificationCompat.FLAG_GROUP_SUMMARY) != 0 && this.mGroupAlertBehavior == 2) {
                    removeSoundAndVibration(notificationBuild3);
                }
                if (notificationBuild3.getGroup() != null && (notificationBuild3.flags & NotificationCompat.FLAG_GROUP_SUMMARY) == 0 && this.mGroupAlertBehavior == 1) {
                    removeSoundAndVibration(notificationBuild3);
                }
            }
