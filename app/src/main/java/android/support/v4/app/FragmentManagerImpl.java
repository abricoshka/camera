...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    static boolean shouldRunOnHWLayer(View view, AnimationOrAnimator animationOrAnimator) {
        ...
        return modifiesAlpha(animationOrAnimator);
    }
    ...
    static AnimationOrAnimator makeOpenCloseAnimation(Context context, float f, float f2, float f3, float f4) {
        ...
        return new AnimationOrAnimator(animationSet, (AnimationOrAnimator) null);
    }
    ...
    static AnimationOrAnimator makeFadeAnimation(Context context, float f, float f2) {
        ...
        alphaAnimation.setInterpolator(DECELERATE_CUBIC);
        alphaAnimation.setDuration(220L);
        return new AnimationOrAnimator(alphaAnimation, (AnimationOrAnimator) null);
    }
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment, int i, boolean z, int i2) throws Resources.NotFoundException {
        ...
        if (animationOnCreateAnimation != null) {
            return new AnimationOrAnimator(animationOnCreateAnimation, animationOrAnimator);
        }
        Animator animatorOnCreateAnimator = fragment.onCreateAnimator(i, z, nextAnim);
        if (animatorOnCreateAnimator != null) {
            return new AnimationOrAnimator(animatorOnCreateAnimator, animationOrAnimator);
        }
        if (nextAnim != 0) {
            ...
            if (zEquals) {
                try {
                    ...
                    if (animationLoadAnimation != null) {
                        return new AnimationOrAnimator(animationLoadAnimation, (AnimationOrAnimator) null);
                    }
                    z2 = true;
            ...
            if (!z2) {
                try {
                    ...
                    if (animatorLoadAnimator != null) {
                        return new AnimationOrAnimator(animatorLoadAnimator, (AnimationOrAnimator) null);
                    }
                    ...
                    if (animationLoadAnimation2 != null) {
                        return new AnimationOrAnimator(animationLoadAnimation2, animationOrAnimator);
                    }
                }
            }
        }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    void moveToState(android.support.v4.app.Fragment r11, int r12, int r13, int r14, boolean r15) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    private void animateRemoveFragment(@NonNull final Fragment fragment, @NonNull AnimationOrAnimator animationOrAnimator, int i) {
        ...
        if (animationOrAnimator.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(getAnimationListener(animation)) { // from class: android.support.v4.app.FragmentManagerImpl.2
                {
                    AnimationListenerWrapper animationListenerWrapper = null;
                }
                ...
                public void onAnimationEnd(Animation animation2) throws Resources.NotFoundException {
    ...
    void completeShowHideFragment(final Fragment fragment) throws Resources.NotFoundException {
        if (fragment.mView != null) {
            ...
            if (animationOrAnimatorLoadAnimation != null && animationOrAnimatorLoadAnimation.animator != null) {
                ...
                fragment.mView.setVisibility((fragment.mHidden && (fragment.isHideReplaced() ^ true)) ? 8 : 0);
                if (fragment.isHideReplaced()) {
                    fragment.setHideReplaced(false);
                }
            }
    ...
    */
    void moveToState(int r7, boolean r8) throws android.content.res.Resources.NotFoundException {
        /*
            r6 = this;
            r3 = 0
        ...
        while (i3 < size) {
            if (arrayList.get(i3).mReorderingAllowed) {
                ...
                if (arrayList2.get(i3).booleanValue()) {
                    while (i5 < size && arrayList2.get(i5).booleanValue()) {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2, ArraySet<Fragment> arraySet) throws Resources.NotFoundException {
        ...
        while (i4 >= i) {
            ...
            if (backStackRecord.isPostponed() ? !backStackRecord.interactsWith(arrayList, i4 + 1, i2) : false) {
    ...
    private static void executeOps(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) throws Resources.NotFoundException {
        while (i < i2) {
    ...
    private static void setRetaining(FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        if (childNonConfigs != null) {
            Iterator<T> it2 = childNonConfigs.iterator();
            while (it2.hasNext()) {
    ...
    Bundle saveFragmentBasicState(Fragment fragment) throws Resources.NotFoundException {
        Bundle bundle;
    ...
    public void dispatchReallyStop() throws Resources.NotFoundException {
        dispatchStateChange(2);
    }
    ...
    private void dispatchStateChange(int i) throws Resources.NotFoundException {
        try {
            this.mExecutingActions = true;
            moveToState(i, false);
            this.mExecutingActions = false;
    ...
    */
    public void unregisterFragmentLifecycleCallbacks(android.support.v4.app.FragmentManager.FragmentLifecycleCallbacks r5) {
        /*
            r4 = this;
            java.util.concurrent.CopyOnWriteArrayList<android.support.v4.util.Pair<android.support.v4.app.FragmentManager$FragmentLifecycleCallbacks, java.lang.Boolean>> r2 = r4.mLifecycleCallbacks
            monitor-enter(r2)
            r0 = 0
            java.util.concurrent.CopyOnWriteArrayList<android.support.v4.util.Pair<android.support.v4.app.FragmentManager$FragmentLifecycleCallbacks, java.lang.Boolean>> r1 = r4.mLifecycleCallbacks     // Catch: java.lang.Throwable -> L24
            int r3 = r1.size()     // Catch: java.lang.Throwable -> L24
            r1 = r0
        Lb:
            if (r1 >= r3) goto L1e
            java.util.concurrent.CopyOnWriteArrayList<android.support.v4.util.Pair<android.support.v4.app.FragmentManager$FragmentLifecycleCallbacks, java.lang.Boolean>> r0 = r4.mLifecycleCallbacks     // Catch: java.lang.Throwable -> L24
            java.lang.Object r0 = r0.get(r1)     // Catch: java.lang.Throwable -> L24
            android.support.v4.util.Pair r0 = (android.support.v4.util.Pair) r0     // Catch: java.lang.Throwable -> L24
            F r0 = r0.first     // Catch: java.lang.Throwable -> L24
            if (r0 != r5) goto L20
            java.util.concurrent.CopyOnWriteArrayList<android.support.v4.util.Pair<android.support.v4.app.FragmentManager$FragmentLifecycleCallbacks, java.lang.Boolean>> r0 = r4.mLifecycleCallbacks     // Catch: java.lang.Throwable -> L24
    ...
    private static class AnimationOrAnimator {
        ...
        /* synthetic */ AnimationOrAnimator(Animator animator, AnimationOrAnimator animationOrAnimator) {
            this(animator);
        }

        /* synthetic */ AnimationOrAnimator(Animation animation, AnimationOrAnimator animationOrAnimator) {
            this(animation);
        }
    ...
    private static class AnimationListenerWrapper implements Animation.AnimationListener {
        ...
        /* synthetic */ AnimationListenerWrapper(Animation.AnimationListener animationListener, AnimationListenerWrapper animationListenerWrapper) {
