...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner {
    ...
    public final boolean isVisible() {
        return isAdded() && (isHidden() ^ true) && this.mView != null && this.mView.getWindowToken() != null && this.mView.getVisibility() == 0;
    }
    ...
    public void setUserVisibleHint(boolean z) throws Resources.NotFoundException {
        ...
        this.mDeferStart = this.mState < 4 ? !z : false;
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    @Deprecated
    public LayoutInflater getLayoutInflater(Bundle bundle) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException {
        if (this.mHost == null) {
    ...
    void performSaveInstanceState(Bundle bundle) throws Resources.NotFoundException {
