...
public class Matrix3f {
    ...
    public void loadRotate(float f, float f2, float f3, float f4) {
        ...
        this.mMat[3] = (f8 * f7) - f13;
        this.mMat[6] = (f10 * f7) + f12;
        this.mMat[1] = f13 + (f8 * f7);
        this.mMat[4] = (f3 * f3 * f7) + fCos;
        this.mMat[7] = (f9 * f7) - f11;
        this.mMat[2] = (f10 * f7) - f12;
        this.mMat[5] = (f9 * f7) + f11;
        this.mMat[8] = (f7 * f4 * f4) + fCos;
    }
        ...
        while (true) {
            ...
            if (i2 < 2) {
                for (int i3 = i2 + 1; i3 < 3; i3++) {
                    float f = this.mMat[(i2 * 3) + i3];
                    this.mMat[(i2 * 3) + i3] = this.mMat[(i3 * 3) + i2];
                    this.mMat[(i3 * 3) + i2] = f;
                }
                i = i2 + 1;
            } else {
