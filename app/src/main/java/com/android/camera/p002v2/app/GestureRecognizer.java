...
import com.android.camera.p002v2.app.DownUpDetector;
import com.mediatek.camera.debug.LogHelper;

/* loaded from: classes.dex */
public class GestureRecognizer {
    private static final LogHelper.Tag TAG = new LogHelper.Tag(GestureRecognizer.class.getSimpleName());
    ...
    public GestureRecognizer(Context context, Listener listener) {
        ...
        LogHelper.m26i(TAG, "GestureRecognizer");
    ...
    public void onTouchEvent(MotionEvent motionEvent) {
        LogHelper.m26i(TAG, "Gesture onTouchEvent");
    ...
    private class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            LogHelper.m26i(GestureRecognizer.TAG, "MyGestureListener onSingleTapUp");
        ...
        public void onLongPress(MotionEvent motionEvent) {
            LogHelper.m26i(GestureRecognizer.TAG, "MyGestureListener onLongPress");
    ...
    private class MyDownUpListener implements DownUpDetector.DownUpListener {
        ...
        @Override // com.android.camera.v2.app.DownUpDetector.DownUpListener
