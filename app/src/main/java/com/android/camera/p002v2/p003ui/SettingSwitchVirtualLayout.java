...
public class SettingSwitchVirtualLayout extends RotateLayout implements AdapterView.OnItemClickListener {
    private static final LogHelper.Tag TAG = new LogHelper.Tag("SwitchVirtualLayout");
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            LogHelper.m26i(SettingSwitchVirtualLayout.TAG, "getView mPrefs[position]" + listPreference);
            ...
            LogHelper.m26i(SettingSwitchVirtualLayout.TAG, "pref.getValue = " + overrideValue + ", index = " + iFindIndexOfValue);
            ...
            CameraUtil.setEnabledState(view, SettingSwitchVirtualLayout.this.mIsSublistItemEnable);
            return view;
        }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        ...
        LogHelper.m26i(TAG, "pref.getValue = " + value + ", ind = " + iFindIndexOfValue);
        if (iFindIndexOfValue == 0) {
            viewHolder.mCheckBox.setChecked(false);
