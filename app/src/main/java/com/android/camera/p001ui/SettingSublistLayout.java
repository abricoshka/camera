...
public class SettingSublistLayout extends RotateLayout implements AdapterView.OnItemClickListener {
    ...
    public void reloadPreference() {
        ...
        if (iFindIndexOfValue != -1) {
            ...
            Log.m6e("SettingSublistLayout", "Invalid preference value.");
            this.mPreference.print();
        }
        Log.m8i("SettingSublistLayout", "reloadPreference() mPreference=" + this.mPreference + ", index=" + iFindIndexOfValue);
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        Log.m5d("SettingSublistLayout", "onItemClick(" + i + ", " + j + ") and oldIndex = " + this.mAdapter.getSelectedIndex());
