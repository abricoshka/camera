...
public class Renderer {
    ...
    protected FloatBuffer createFloatBuffer(FloatBuffer floatBuffer, float[] fArr) {
        if (floatBuffer == null) {
            Log.m35v("Renderer", "ByteBuffer.allocateDirect");
    ...
    protected int initBitmapTexture(int i, boolean z) throws Resources.NotFoundException, IOException {
        ...
        int[] iArr = new int[1];
        Log.m31d("Renderer", "Renderer initBitmapTexture glGenTextures num = 1");
        ...
        try {
            ...
            if (z) {
                ...
                Log.m35v("Renderer", "read cousume " + (System.currentTimeMillis() - jCurrentTimeMillis) + "ms bitmap width = " + width + " bitmap height = " + height + " minX = " + i6 + " minY = " + i5 + " maxX = " + i3 + " maxY = " + i4);
                ...
                Log.m35v("Renderer", "new bitmap width = " + bitmapCreateBitmap.getWidth() + " height = " + bitmapCreateBitmap.getHeight() + " translateXRatio = " + f + " translateYRatio = " + f2 + " scaleRatio = " + f3);
            } else {
    ...
    protected void releaseBitmapTexture(int i) {
        ...
        Log.m31d("Renderer", "Renderer releaseBitmapTexture glDeleteTextures num = 1");
    }
    ...
    public int createProgram(String str, String str2) {
        ...
        Log.m32e("Renderer", "Could not link program:");
        Log.m32e("Renderer", GLES20.glGetProgramInfoLog(iGlCreateProgram));
    ...
    public int loadShader(int i, String str) {
        ...
        Log.m32e("Renderer", "Could not compile shader(TYPE=" + i + "):");
        Log.m32e("Renderer", GLES20.glGetShaderInfoLog(iGlCreateShader));
    ...
    public void debugFrameRate(String str) {
        ...
        if (this.mDrawFrameCount % 300 == 0) {
            ...
            Log.m31d(str, "[Wrapping-->" + str + "][Preview] Drawing frame, fps = " + ((this.mDrawFrameCount * 1000.0f) / i) + " in last " + i + " millisecond.");
