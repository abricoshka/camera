...
public class RotateImageView extends TwoStateImageView implements Rotatable {
    ...
    public void setOrientation(int i, boolean z) {
        Log.m31d("RotateImageView", "[setOrientation]degree = " + i + ", animation=" + z + ",mOrientation=" + this.mTargetDegree);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable == null) {
            Log.m32e("RotateImageView", "[onDraw]drawable == null, return!");
            return;
        }
        ...
        if (i == 0 || i2 == 0) {
            Log.m32e("RotateImageView", "[onDraw]w == 0 || h == 0, return!");
            return;
        }
