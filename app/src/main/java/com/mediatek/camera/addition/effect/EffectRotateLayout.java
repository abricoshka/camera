...
public class EffectRotateLayout extends ViewGroup implements Rotatable {
    ...
    public EffectRotateLayout(Context context, AttributeSet attributeSet) {
    ...
    public void setOrientation(int i, boolean z) {
        Log.m5d("EffectRotateLayout", "[setOrientation]orientation = " + i + ",mOrientation = " + this.mOrientation + ",animation=" + z);
